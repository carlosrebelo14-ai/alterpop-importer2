...
export async function insertCatalogProductBatch(shop, chunk, options = {}) {
  ...
  for (let i = 0; i < unique.length; i += CHUNK) {
    ...
    const sql = `
      INSERT INTO CatalogProduct (shop, sku, title, categoryMain, categorySegments, vendor, vendorNorm, stock, franchises, franchiseRefs, resolvedFranchise, resolvedFranchiseLayer, resolvedLine, netPrice, grossPrice, imageUrl, barcode, weightKg, titleSource, dimensions, hsCode, originalTitle, cleanTitle, resolvedFormat, indexedAt)
