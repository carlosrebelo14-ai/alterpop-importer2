...
export function toLiteProduct(r) {
  ...
  const cleanTitle = cleanProductTitle({ title, resolvedFranchise: resolved.franchise });
  // Tarefa 34 — formato de produto (Figure, Keychain, Backpack, …), o vocabulário que
  // saiu de FORMAT_PREFIXES na Tarefa 32. Alimenta alterpop.format no publish (Tarefa 35).
