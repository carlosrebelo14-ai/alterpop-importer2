 ...
 *
 * Derivada de franchiseUniverses.js (40 universos) + franchiseLines.js (1 Line). O
...
/** @typedef {{ handle: string, condition: string, metafield: "alterpop.franchise" | "alterpop.line", templateSuffix: string, kind: "universe" | "line", active: boolean }} FranchiseCondition */
