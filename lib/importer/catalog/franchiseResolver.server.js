 ...
 *  Reduzida na Tarefa 32 (Decisão 17, 2026-09-11): o censo da Tarefa 31 mostrou que
 *  "POP figure" sozinho valia 79% de todas as remoções (4327/5455) — informação de
 *  formato genuína (Funko Pop vs. outro tipo de produto), não ruído. "Loungefly",
 *  "Pocket POP Keychain", "Blister N figures Bitty POP", "Figure POP", "Display Bitty
 *  POP", "Blind box", "Deluxe" e "Set" saíram pelo mesmo motivo — nomes de linha/marca
 *  ou formato com valor informativo, não lixo de fornecedor. Ficam só os dois casos
 *  que são mesmo ruído sem informação nenhuma: "Assorted" (variante aleatória de uma
 *  caixa, não diz nada sobre o produto) e "Latino" (locale do fornecedor). */
const FORMAT_PREFIXES = ["Assorted", "Latino"].sort((a, b) => b.length - a.length);
