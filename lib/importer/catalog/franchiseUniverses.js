...
/** @typedef {{ name: string, handle: string, refs: string[], titlePatterns: string[], baseline: number, active: boolean, dormant?: boolean, priority?: number }} FranchiseUniverse */
...
export const FRANCHISE_UNIVERSES = [
  ...
  { name: "Pokémon", handle: "pokemon-universe", refs: ["Pokemon"], titlePatterns: ["Pokemon", "Pokémon"], baseline: 622, active: true },
  ...
  { name: "Wonder Woman", handle: "wonder-woman", refs: ["Wonderwoman"], titlePatterns: ["Wonder Woman"], baseline: 5, active: false, dormant: true },
  ...
  { name: "Avengers", handle: "avengers", refs: ["Los Vengadores", "Iron Man"], titlePatterns: ["Avengers", "Vengadores", "Iron Man"], baseline: 274, active: true },
  ...
  { name: "X-Men", handle: "x-men", refs: ["Xmen", "Deadpool"], titlePatterns: ["X-Men", "Xmen", "Deadpool"], baseline: 93, active: true, priority: 10 },
  ...
  { name: "Toy Story", handle: "toystory", refs: ["Toystory"], titlePatterns: ["Toy Story"], baseline: 214, active: true },
  ...
  { name: "Sailor Moon", handle: "sailor-moon", refs: ["Sailormoon"], titlePatterns: ["Sailor Moon"], baseline: 7, active: false, dormant: true },
  ...
  { name: "Final Fantasy", handle: "final-fantasy", refs: [], titlePatterns: ["Final Fantasy"], baseline: 6, active: false, dormant: true },
  { name: "Resident Evil", handle: "resident-evil", refs: [], titlePatterns: ["Resident Evil", "Biohazard"], baseline: 4, active: false, dormant: true },
  { name: "The Last of Us", handle: "the-last-of-us", refs: ["Lastofus"], titlePatterns: ["The Last of Us"], baseline: 8, active: false, dormant: true },
