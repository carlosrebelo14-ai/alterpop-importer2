...
export const FRANCHISE_UNIVERSES = [
  ...
  { name: "Demon Slayer", handle: "demon-slayer", refs: ["Demon Slayer", "Kimetsuno Yaiba"], titlePatterns: ["Demon Slayer", "Kimetsu no Yaiba"], estRange: [75, 138], active: true },
  ...
  { name: "Mickey & Friends", handle: "mickey-and-friends", refs: ["Mickey", "Minnie", "Donald", "Pato Donald"], titlePatterns: ["Mickey", "Minnie", "Donald Duck"], estRange: [71, 138], active: true },
  ...
  { name: "Hello Kitty / Sanrio", handle: "hello-kitty", refs: ["Hello Kitty"], titlePatterns: ["Hello Kitty", "Sanrio", "Kuromi", "My Melody"], estRange: [72, 72], active: true },
  ...
  { name: "Studio Ghibli", handle: "studio-ghibli", refs: [], titlePatterns: ["Ghibli", "Totoro", "Spirited Away", "Howl"], estRange: [0, 0], active: false },
