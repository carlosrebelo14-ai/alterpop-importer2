...
export const FRANCHISE_UNIVERSES = [
  ...
  // #40 — Decisão 7 (2026-09-11). Filme Netflix 2025, NÃO género musical: confirmado
  // pela Tarefa 18 (kpop-demon-hunters-overlap.js) — 83,2% dos 250 órfãos "kpop" têm
  // também "demon"/"hunters" no título, e 253/253 têm o ref "KPopDemonHunters". Padrão
  // de título restrito a "KPop Demon Hunters" (não "KPop" isolado — ~17% dos "kpop" são
  // produtos distintos sem ligação ao filme: "Kpop Diva Squad", DJ Ministation, etc.).
  { name: "KPop Demon Hunters", handle: "kpop-demon-hunters",
    refs: ["KPopDemonHunters"],
    titlePatterns: ["KPop Demon Hunters", "Kpop Demon Hunters"],
    baseline: 253, active: true },
];
