...
export function getDefaultConfig() {
  return {
    shopify: {
      ...
      // B14 (briefing backend, 24/09/2026), secção 6. Validado a cada ciclo contra
      // publications { nodes { id } } — nunca confiado às cegas (collectionPublication.server.js).
      onlineStorePublicationId:
        process.env.SHOPIFY_ONLINE_STORE_PUBLICATION_ID || "gid://shopify/Publication/348809331018",
    },
    ociostock: {
