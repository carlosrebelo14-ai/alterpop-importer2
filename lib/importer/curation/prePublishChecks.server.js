 ...
 *
 *  checkSupplierTokens/runPrePublishChecks hoje só correm sobre payload de PRODUTO
 *  (shopifyMapper.server.js, live-publish-audit.js) — sem chamador nenhum sobre
 *  payload de COLEÇÃO. A extensão de coleção só passa a apitar de facto quando
 *  collectionPublication.server.js (briefing 24/09/2026, secção 6) chamar esta
 *  verificação sobre a descriptionHtml da coleção antes do publishablePublish. */
