 ...
 * 39 entradas da tabela (ativas e dormentes).
 *
 * B14 (briefing 24/09/2026, secção 3): universeCollections.server.js deixou de escrever
 * descriptionHtml na criação — a coleção nasce vazia, sem placeholder e sem esta copy.
 * Este mapa fica só para o backfill pontual (fix-universe-collection-descriptions.mjs).
 *
