 ...
 *
 * NÃO chama publishCollectionOnCreation (collectionPublication.server.js, B14 secção 6)
 * — esta função só é chamada hoje pelo script manual universe-collections-plan.js
 * (Fase 7, `--create`), fora do ciclo automático. A publicação-na-criação liga-se ao
 * ciclo real que cria coleções automaticamente (trigger-sync, secção 8, por escrever).
 * @param {import('../shopifyClient.js').ShopifyClient} client
