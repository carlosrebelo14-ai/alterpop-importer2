...
export async function translateProductRecord(record, job) {
  ...
  // INVARIANTE: só `record.franchises` é traduzível. NÃO adicionar `record.franchiseRefs`
  // a este loop — são refs de vocabulário controlado do fornecedor (BLACKCLOVER,
  // STAR_WARS_EP) e a chave de mapeamento da camada 1 do franchiseResolver; traduzi-los
  // destrói o mapa. Ver docs/PLANO-normalizacao-franquias.md §9.
